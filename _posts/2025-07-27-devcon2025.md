...
- Use [molab](https://marimo.io/blog/announcing-molab) instead of Google Colab. Molab as created by the creators of marimo and offers similar compute and sharing capabilities.
...
- [top500.org](https://top500.org/) is a website that maintains a list of the 500 most powerful computers in the world. As per its [statistics](https://top500.org/statistics/list/), all the supercomputers are running the Linux operating system family.
